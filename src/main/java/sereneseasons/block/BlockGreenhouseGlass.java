...
public class BlockGreenhouseGlass extends BlockBreakable implements ISSBlock {
    ...
    /**
     * Gets the render layer this block will render on. SOLID for solid blocks, CUTOUT or
     * CUTOUT_MIPPED for on-off transparency (glass, reeds), TRANSLUCENT for fully blended
     * transparency (stained glass)
     */
    @Override
