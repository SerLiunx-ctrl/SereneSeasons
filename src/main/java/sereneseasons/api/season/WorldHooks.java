...
public class WorldHooks {
    ...
    public static boolean canSnowAtInSeason(
            World world, BlockPos pos, boolean checkLight, ISeasonState seasonState) {
        try {
            return (Boolean)
                    Class.forName("sereneseasons.season.SeasonASMHelper")
                            .getMethod(
                                    ...
                                    Boolean.class,
                                    ISeasonState.class)
                            .invoke(null, world, pos, checkLight, seasonState);
        } catch (Exception e) {
    ...
    public static boolean canBlockFreezeInSeason(
            World world, BlockPos pos, boolean noWaterAdj, ISeasonState seasonState) {
        try {
            return (Boolean)
                    Class.forName("sereneseasons.season.SeasonASMHelper")
                            .getMethod(
                                    ...
                                    Boolean.class,
                                    ISeasonState.class)
                            .invoke(null, world, pos, noWaterAdj, seasonState);
        } catch (Exception e) {
            ...
            return (Boolean)
                    Class.forName("sereneseasons.season.SeasonASMHelper")
                            .getMethod(
                                    ...
                                    BlockPos.class,
                                    ISeasonState.class)
                            .invoke(null, world, pos, seasonState);
        } catch (Exception e) {
