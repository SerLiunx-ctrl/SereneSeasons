...
public class WorldTransformer implements IClassTransformer {
    private static final String[] CAN_SNOW_AT_NAMES =
            new String[] {"canSnowAt", "func_175708_f", "f"};
    private static final String[] CAN_BLOCK_FREEZE_NAMES =
            new String[] {"canBlockFreeze", "func_175670_e", "e"};
    private static final String[] IS_RAINING_AT_NAMES =
            new String[] {"isRainingAt", "func_175727_C", "B"};
    private static final String[] GET_BIOME_GEN_FOR_COORDS_NAMES =
            new String[] {"getBiome", "func_180494_b", "b"};
    ...
    private byte[] transformWorld(byte[] bytes, boolean obfuscatedClass) {
        ...
        for (MethodNode methodNode : classNode.methods) {
            if (ASMHelper.methodEquals(
                    methodNode,
                    CAN_SNOW_AT_NAMES,
                    ObfHelper.createMethodDescriptor(
                            obfuscatedClass, "Z", "net/minecraft/util/math/BlockPos", "Z"))) {
                ...
                insnList.add(
                        new MethodInsnNode(
                                Opcodes.INVOKESTATIC,
                                "sereneseasons/season/SeasonASMHelper",
                                "canSnowAtInSeason",
                                ObfHelper.createMethodDescriptor(
                                        obfuscatedClass,
                                        "Z",
            ...
            } else if (ASMHelper.methodEquals(
                    methodNode,
                ...
                successfulTransformations.add(methodNode.name + " " + methodNode.desc);
                    ...
                    IS_RAINING_AT_NAMES,
                    ObfHelper.createMethodDescriptor(
                            obfuscatedClass, "Z", "net/minecraft/util/math/BlockPos"))) {
                InsnList insnList = new InsnList();
                ...
                MethodInsnNode invokeMethodNode =
                        ASMHelper.getUniqueMethodInsnNode(
                                methodNode,
                                Opcodes.INVOKEVIRTUAL,
                                ObfHelper.unmapType(obfuscatedClass, "net/minecraft/world/World"),
