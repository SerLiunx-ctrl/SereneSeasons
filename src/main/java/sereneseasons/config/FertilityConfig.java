...
public class FertilityConfig {
    ...
    public static class General {
        ...
        @Config.Comment({
            "Whether unlisted seeds are fertile every season. False means they're fertile every"
                + " season except Winter"
        })
        public boolean ignore_unlisted_crops = false;

        @Config.Comment({
            "Whether to include tooltips on crops listing which seasons they're fertile in. Note:"
                + " This only applies to listed crops."
        })
    ...
    public static class SeasonFertility {
        @Config.Comment({
            "Crops growable in Spring (List either the seed item for the crop, or the crop block"
                + " itself)"
        })
        ...
        @Config.Comment({
            "Crops growable in Summer (List either the seed item for the crop, or the crop block"
                + " itself)"
        })
        ...
        @Config.Comment({
            "Crops growable in Autumn (List either the seed item for the crop, or the crop block"
                + " itself)"
        })
        ...
        @Config.Comment({
            "Crops growable in Winter (List either the seed item for the crop, or the crop block"
                + " itself)"
        })
